				...
				<div class="col-md-10">
				   ...
				   <c:forEach items="${list}" var="hot">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="">${hot.pname}</a></p>
						<p><font color="#E4393C" style="font-size:16px">${hot.marketPrice}</font></p>
					</div>
				   </c:forEach>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
				  ...
				  <c:forEach items="${li}" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath}/seleKey/${p.pid}">

							<img src="${pageContext.request.contextPath}/${p.pimage}" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath}/seleKey/${p.pid}}" style='color:#666'>${p.pname}</a></p>
						<p><font color="#E4393C" style="font-size:16px">${p.marketPrice}</font></p>
					</div>
				  </c:forEach>
				</div>
			</div>
